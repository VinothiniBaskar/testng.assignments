...
public class ReadExcelData {
	...
	public static String[][] readExcel(String ExcelFileName) throws IOException {
		// Create an object for XSSFWorkbook and pass the path of the excel sheet
		XSSFWorkbook wbook = new XSSFWorkbook("data/" + ExcelFileName + ".xlsx");
		// XSSFSheet represents the excel sheet in the excel
		// use that XSSFWorkbook object(wbook)--->Get the sheet1 using getSheetAt(0)-->0
		// represents 1st sheet in excel
